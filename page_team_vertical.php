	...
	<div class="gallery-wrapper" id="vertical">
		...
		<ul class="gallery vertical  <?php if( get_option('portfolio_animate','1') == 1) echo 'animate'; ?>">
			...
			<?php 
				 ...
				 */
				if(!( MultiPostThumbnails::get_post_thumbnail_url(get_post_type(), 'team-vertical') ))
					continue;
			?>
				...
				<li <?php post_class(); ?>>
					<a href="<?php the_permalink(); ?>">
						<?php 
							 ...
							 * Class defined in /ebor_framework/post_thumbnails.php
							 */
							MultiPostThumbnails::the_post_thumbnail(get_post_type(), 'team-vertical'); 
						?>
